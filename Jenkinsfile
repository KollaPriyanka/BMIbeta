        ...
        /*stage("Quality Gate") {
         ...
         stage("collecting") {
            steps {
                ...
                script
                {
               def var = sh "curl --location --request GET 'http://3.16.33.107:9000/api/measures/component?metricKeys=ncloc,complexity,violations&component=EDN250'"               echo '----var----' + var
                }
