        ...
        /*stage("Quality Gate") {
         ...
         stage("collecting") {
            steps {
                ...
                sh'curl -i -H "Content-Type: application/json" -H "x-api-key:token" -X GET http://3.16.33.107:9000/api/measures/component?metricKeys=violations&component=comrades.bmi:BMI'
